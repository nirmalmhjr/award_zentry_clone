...
const Hero = () => {
  ...
  const [isLoading, setIsLoading] = useState(true); //video load takes times at start
  ...
  useGSAP(() => {
    gsap.set("#video-frame", {
      clipPath: "polygon(14% 1%, 72% 0%, 90% 90%, 0% 100%)",
      ...
      >
        <div>
          <div className="mask-clip-path absolute-center absolute z-50 size-64 cursor-pointer overflow-hidden rounded-lg ">
            ...
            <div
              className="cursor-pointer origin-center  scale-50 opacity-0 transition-all duration-300 ease-in hover:scale-100 hover:opacity-100"
